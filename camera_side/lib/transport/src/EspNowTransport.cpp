...
// cyd ac:15:18:d6:bd:e0
// red 2C:BC:BB:B5:BF:F4
#ifdef CYD_DISPLAY
const uint8_t broadcastAddress[] = {0xac, 0x15, 0x18, 0xd6, 0xbd, 0xe0};
#else
const uint8_t broadcastAddress[] = {0x2c, 0xbc, 0xbb, 0xb5, 0xbf, 0xf4};
// const uint8_t broadcastAddress[] = {0xac, 0x15, 0x18, 0xd6, 0xbd, 0xe0};
#endif
