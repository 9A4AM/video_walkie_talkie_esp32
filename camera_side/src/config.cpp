...
i2s_config_t i2s_mic_Config = {
    ...
    .sample_rate = SAMPLE_RATE,
    .bits_per_sample = I2S_BITS_PER_SAMPLE_16BIT, //i2s_bits_per_sample_t(16),//I2S_BITS_PER_SAMPLE_32BIT,//
    #else
    ...
    #endif
    // .sample_rate = SAMPLE_RATE,
    // .bits_per_sample = i2s_bits_per_sample_t(16),//I2S_BITS_PER_SAMPLE_32BIT,//
    .channel_format = I2S_MIC_CHANNEL,
#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(4, 2, 0)
    .communication_format = (i2s_comm_format_t)(I2S_COMM_FORMAT_STAND_I2S),//(I2S_COMM_FORMAT_PCM),//(I2S_COMM_FORMAT_STAND_I2S),
#else
