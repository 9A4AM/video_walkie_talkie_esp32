...
Application::Application()
{
  ...
  m_input = new I2SMEMSSampler(I2S_NUM_0, i2s_mic_pins, i2s_mic_Config,128); //I2S_NUM_0
#else
  m_input = new ADCSampler(ADC_UNIT_1, ADC1_CHANNEL_7, i2s_adc_config);
#endif

#ifdef USE_SPEAKER_AT_ALL
...
void Application::begin()
{
  ...
  while(!m_transport->begin()){
    digitalWrite(4, HIGH);
    delay(1000);
    Serial.println("Retrying Transport Begin");

  }
  digitalWrite(4, LOW);
  Serial.println("Transport Begin Success");
